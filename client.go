...
// APIClient manages communication with the standard public schema API v12.2.3
...
type APIClient struct {
	...
	AlembicVersionAPI *AlembicVersionAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AlembicVersionAPI = (*AlembicVersionAPIService)(&c.common)
